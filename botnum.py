...
# REMOVED: Channel membership check function - everyone gets access now
...
def send_welcome(message):
    ...
    # REMOVED: Channel membership check - everyone gets direct access now
...
def show_main_menu(chat_id, user_id):
    try:
        ...
        # Send promotional message separately (optional)
        bot.send_message(chat_id,
                        "💡 *Optional:* Join our channels for updates and OTP codes:",
                        parse_mode='Markdown',
...
def process_callback(call):
    ...
    if call.data.startswith("country_"):
        ...
        # REMOVED: Channel membership check - direct access granted
...
if __name__ == "__main__":
    ...
    print("📢 Channel join requirement: DISABLED - Everyone gets direct access!")
    try:
